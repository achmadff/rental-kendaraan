...
include("koneksi.php");
    $id = $_GET['id'];
    $select_kendaraan	= mysqli_query($koneksi, "SELECT * FROM kendaraan WHERE id_pemesanan='$id'");
    ...
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Detail Pemesanan Kode - <?= $row_kendaraan['name_kendaraan']?></h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
